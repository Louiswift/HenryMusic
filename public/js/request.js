...
const getNewSong = async () => {
  const resp = await fetch('https://henrywang.xyz/personalized/newsong?limit=20');
...
async function getDailySongRecommendations(){
  const resp = await fetch(`https://henrywang.xyz/recommend/songs`);
  return await resp.json();
}
...
const recommendedPlaylists = async () => {
  const resp = await fetch('https://henrywang.xyz/personalized?limit=9');
  return await resp.json();
}
...
const getAllsongsOnThePlaylist = async (PlayListId) => {
  const resp = await fetch(`https://henrywang.xyz/playlist/track/all?limit=20&id=${PlayListId}&offset=1`);
  return await resp.json();
}
...
const getSongUrl = async (id) => {
  const resp = await fetch(`https://henrywang.xyz/song/url/v1?id=${id}&level=jymaster`);
  return await resp.json();
}
...
const getPlaylistsDetail = async (id) => {
  const resp = await fetch(`https://henrywang.xyz/playlist/detail?id=${id}`);
  return await resp.json();
}
...
const musicAvailability = async (id) => {
  const resp = await fetch(`https://henrywang.xyz/check/music?id=${id}`);
  return await resp.json();
}
...
async function search(key){
  const resp = await fetch(`https://henrywang.xyz/search?keywords=${key}`);
  return await resp.json();
} 
...
async function searchSuggestions(keywords){
  const resp = await fetch(`https://henrywang.xyz/search/suggest?keywords=${keywords}`);
  return await resp.json();
}
...
async function hotSearch(){
  const resp = await fetch(`https://henrywang.xyz/search/hot/detail`);
  return await resp.json();
} 
...
async function getSongDetails(id){
  const resp = await fetch(`https://henrywang.xyz/song/detail?ids=${id}`);
  return await resp.json();
}
...
async function getsongLyric(id){
  const resp = await fetch(`https://henrywang.xyz/lyric?id=${id}`);
  return await resp.json();
}
...
async function emailLogin(email,password){
  const resp = await fetch(`https://henrywang.xyz/login?email=${email}@163.com&password=${password}`);
  return await resp.json();
}
...
async function visitorLogin(){
  const resp = await fetch(`https://henrywang.xyz/register/anonimous`);
  return await resp.json();
}
...
async function sendVerificationCode(phone){
  const resp = await fetch(`https://henrywang.xyz/captcha/sent?phone=${phone}`);
  return await resp.json();
}
...
async function checkCode(phone,captcha){
  const resp = await fetch(`https://henrywang.xyz/captcha/verify?phone=${phone}&captcha=${captcha}`);
  return await resp.json();
}